...
describe('favorite/', () => {
  ...
  it('It not should be possible to add a new favored plant.', async () => {
    const response = await request.post(`/favorites/add/`).send({
      // no argument is needed
    });
  ...
  it('It not should be possible to add a new favored plant.', async () => {
    const response = await request.post(`/favorites/add/${user.id}/`).send({
      // no argument is needed
    });
    expect(response.status).toBe(404);
  });
  ...
  it('It not should be possible to add a new favored plant.', async () => {
    const response = await request.post(`/favorites/add/${plant.id}/`).send({
      // no argument is needed
    });
    expect(response.status).toBe(404);
  });
  ...
  it('It should be possible to see a list of favorite plants.', async () => {
    const response = await request.get(`/favorites/list/${user.id}/`).send({
      // no argument is needed
    });
    expect(response.status).toBe(200);
  });
  ...
  it('It not should be possible to see a list of favorite plants.', async () => {
    const response = await request.get(`/favorites/list/${plant.id}/`).send({
      // no argument is needed
    });
    expect(response.status).toBe(400);
  });
  ...
  it('It not should be possible to see a list of favorite plants.', async () => {
    const response = await request.get(`/favorites/list/`).send({
      // no argument is needed
    });
    expect(response.status).toBe(404);
  });
  ...
  it('Must be able to delete a favorite plant.', async () => {
    const response = await request.delete(`/favorites/delete/`).send({
      // no argument is needed
    });
    expect(response.status).toBe(404);
  });
